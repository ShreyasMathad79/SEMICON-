...
$$
\mathcal{L}*{\text{total}} =
\mathcal{L}*{\text{charbonnier}}

* 0.25 \cdot \mathcal{L}_{\text{SSIM}}
* 0.15 \cdot \mathcal{L}_{\text{Sobel}}
* 0.05 \cdot \mathcal{L}_{\text{FFT}}
* 0.10 \cdot \mathcal{L}_{\text{Perceptual}}
  $$
